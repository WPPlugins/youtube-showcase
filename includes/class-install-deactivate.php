...
<strong>Medium</strong> - 320 x 180, <strong>High</strong> - 480x360, <strong>Standard</strong> - 640 x 480, <strong>Max</strong> -1280 x 720</p>', 'youtube-showcase') ,
				...
				'options' => array(
					...
					'sd' => __('Standard', 'youtube-showcase') ,
					'mq' => __('Medium', 'youtube-showcase') ,
					'hq' => __('High', 'youtube-showcase') ,
					'maxres' => __('Max', 'youtube-showcase')
				) ,
				'std' => 'mq',
			);
...
<div class="updated">
<?php
				printf('<p><a href="%1s" target="_blank"> %2$s </a>%3$s<a style="float:right;" href="%4$s"><span class="dashicons dashicons-dismiss" style="font-size:15px;"></span>%5$s</a></p>', 'https://emdplugins.com/plugin_tag/yt-scase-com/?pk_campaign=youtube-showcase&pk_source=plugin&pk_medium=link&pk_content=notice', __('Extend or Upgrade YouTube Showcase Now!', 'wpas') , __('&#187;', 'wpas') , esc_url(add_query_arg($this->option_name . '_adm_notice2', true)) , __('Dismiss', 'wpas'));
?>
</div>
<?php
			}
